...
public record AiGenerateQuestionsRequest(
        ...
        @Schema(description = "学科: MATH/CHINESE/ENGLISH/PHYSICS/CHEMISTRY/BIOLOGY/HISTORY/GEOGRAPHY/POLITICS/COMPUTER_SCIENCE", requiredMode = Schema.RequiredMode.REQUIRED)
