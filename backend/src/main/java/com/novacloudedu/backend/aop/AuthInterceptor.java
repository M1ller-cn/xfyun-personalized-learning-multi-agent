...
public class AuthInterceptor {
    ...
    public Object doInterceptor(ProceedingJoinPoint joinPoint, AuthCheck authCheck) throws Throwable {
        return checkAndProceed(joinPoint, authCheck);
    }

    /**
     * Supports controllers whose complete surface is restricted to one role.
     */
    @Around("@within(authCheck)")
    public Object doClassInterceptor(ProceedingJoinPoint joinPoint, AuthCheck authCheck) throws Throwable {
        return checkAndProceed(joinPoint, authCheck);
    }

    private Object checkAndProceed(ProceedingJoinPoint joinPoint, AuthCheck authCheck) throws Throwable {
