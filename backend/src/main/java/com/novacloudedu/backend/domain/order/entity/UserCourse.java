...
public class UserCourse {
    ...
    public static UserCourse createJoined(UserId userId, CourseId courseId, String orderNo, BigDecimal price) {
        LocalDateTime now = LocalDateTime.now();
        return new UserCourse(null, userId, courseId, orderNo, price, null, now,
                null, OrderStatus.PAID, now, now);
    }
