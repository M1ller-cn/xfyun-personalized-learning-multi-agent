...
public class StudentKnowledgeProfile {
    ...
    public static StudentKnowledgeProfile create(UserId studentId, Subject subject, String knowledgePoint) {
        ...
        profile.lastEvidenceAt = null;
        profile.forgettingRisk = 0;
    ...
    public static StudentKnowledgeProfile reconstruct(Long id, UserId studentId, Subject subject,
                                                       ...
                                                       int evidenceCount, LocalDateTime lastEvidenceAt,
        ...
        profile.lastEvidenceAt = lastEvidenceAt;
        profile.forgettingRisk = forgettingRisk;
    ...
    private void recordEvidence() {
        this.evidenceCount++;
        this.lastEvidenceAt = LocalDateTime.now();
        this.forgettingRisk = 0;
    }
