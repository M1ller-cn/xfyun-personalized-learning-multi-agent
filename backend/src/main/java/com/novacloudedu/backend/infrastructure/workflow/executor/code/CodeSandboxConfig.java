...
public class CodeSandboxConfig {
    ...
    /**
     * Docker-in-Docker style deployments share this named volume between the
     * backend container and short-lived Python runner containers.
     */
    private String sharedTempVolume = "";

    /**
     * Optional named volume for cached Python virtual environments.
     */
    private String sharedVenvVolume = "";

    /**
     * Mount point used inside short-lived Python runner containers.
     */
    private String containerWorkRoot = "/sandbox";
