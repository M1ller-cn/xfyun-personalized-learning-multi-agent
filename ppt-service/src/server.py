...
from .oss_client import get_local_storage_dir, upload_bytes as oss_upload
...
# Local fallback artifacts are available to the browser under /files. In an
# OSS-enabled deployment this route remains harmless and simply serves no files.
app.mount("/files", StaticFiles(directory=str(get_local_storage_dir())), name="local-ppt-files")
