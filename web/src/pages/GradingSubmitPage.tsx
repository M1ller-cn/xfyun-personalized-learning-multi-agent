...
import { ArrowLeft, X, Image, Loader2, CheckCircle, AlertCircle, BookOpen, FileText, Sparkles, ChevronDown, Search, Clock, XCircle, ChevronRight, BarChart3, Code2 } from 'lucide-react';
...
import CodeJudgePanel from '../components/grading/CodeJudgePanel';
import LearningAgentInlinePanel from '../components/learning-agent/LearningAgentInlinePanel';
...
type GradingMode = 'GENERAL' | 'EXAM_PAPER' | 'CODE_JUDGE';
        ...
        <>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              />
              <ModeCard
                active={mode === 'CODE_JUDGE'}
                onClick={() => setMode('CODE_JUDGE')}
                icon={<Code2 size={24} />}
                title="代码评测"
                desc="在线写 Python，运行样例和隐藏测试，自动判断 AC/WA/RE"
              />
            </div>
          </div>

          <LearningAgentInlinePanel context="grading" onOpenCodePractice={() => setMode('CODE_JUDGE')} />
