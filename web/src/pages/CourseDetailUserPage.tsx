      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        <div className="xl:col-span-2 space-y-6">
          ...
          <div className="relative aspect-video max-h-[420px] rounded-2xl overflow-hidden bg-gray-100 dark:bg-gray-800 shadow-xl ring-1 ring-black/5 dark:ring-white/5">
            <img src={course.coverImage || visual.cover} alt={course.title} className="w-full h-full object-cover" />
            <div className={`absolute inset-0 bg-gradient-to-t ${visual.accent}`} />
        ...
        <div className="space-y-4">
          ...
          <LearningAgentInlinePanel
            context="course"
            courseTitle={course.title}
            onOpenCodePractice={() => navigate(`/grading?mode=code&courseId=${courseId || ''}`)}
          />
        </div>
      </div>
    </div>
