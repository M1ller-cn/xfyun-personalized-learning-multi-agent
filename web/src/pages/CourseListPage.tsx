            ...
            return (
              ...
              >
                ...
                <div className="relative aspect-video overflow-hidden bg-gray-50 dark:bg-gray-800/50">
                  ...
                  />
                  <div className={`absolute inset-0 bg-gradient-to-br ${visual.accent} opacity-75 mix-blend-multiply`} />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950/70 via-transparent to-transparent" />
                  <div className="absolute bottom-2.5 right-2.5 text-[10px] font-bold uppercase tracking-wide text-white/80 bg-black/25 backdrop-blur-sm px-2 py-1 rounded-md">
                    {visual.provider}
                  </div>
                  {/* 左上角标签 */}
