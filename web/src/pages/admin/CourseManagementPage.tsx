          ...
          <table className="w-full text-left border-collapse admin-table">
            <thead>
              <tr className="bg-gray-50/50 dark:bg-gray-800/50 border-b border-gray-100 dark:border-gray-800 transition-colors duration-300">
                ...
                <th className="px-6 py-4 text-xs font-bold text-gray-400 uppercase tracking-wider">课程码</th>
              ...
              {loading ? (
                Array.from({ length: 5 }).map((_, i) => (
                  <tr key={i} className="animate-pulse">
                    <td colSpan={7} className="px-6 py-8 h-20">
                  ...
                  <tr key={String(course.id)} className="hover:bg-gray-50/50 dark:hover:bg-gray-800/30 transition-colors group">
                    ...
                    <td className="px-6 py-4">
                      <button
                        ...
                        className="inline-flex items-center gap-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/60 px-3 py-2 text-sm font-bold text-gray-700 dark:text-gray-200 hover:border-brand-300 hover:text-brand-600 dark:hover:text-brand-400 transition-colors"
                        title="复制课程码">
                        <KeyRound size={14} />
                        <span>{course.joinCode || '-'}</span>
                        {course.joinCode && <Copy size={13} className="text-gray-400" />}
                      </button>
                    </td>
                    <td className="px-6 py-4">
